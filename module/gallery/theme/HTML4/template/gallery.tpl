...
<div id="slide_menu_container" style="z-index:200000;">
	<div id="slide_menu" style="background:url(<?=ROOT_URI?>/module/gallery/theme/image/toolbar.png) no-repeat;">
		...
		<a href="" id="slide_next"><img src="<?=ROOT_URI?>/module/gallery/theme/image/next.png" border="0"></a>
		<a href="" id="slide_stop"><img src="<?=ROOT_URI?>/module/gallery/theme/image/stop.png" border="0"></a>
		<p id="slide_num"></p>
	</div>
</div>
...
<script type="text/javascript">
	...
	$("#slide_play").click(
		function(){
			if(breakPlay){
				$("#slide_play img").attr('src', '<?=ROOT_URI?>/module/gallery/theme/image/pause.png');
				breakPlay = false;
				nextSlide(true);
			}else{
				$("#slide_play img").attr('src', '<?=ROOT_URI?>/module/gallery/theme/image/play.png');
